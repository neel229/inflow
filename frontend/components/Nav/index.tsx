...
const Nav = () => {
  return (
    <nav className="h-14 w-screen flex justify-between items-center p-1 text-white bg-black border-b border-gray-900">
      <div className="flex items-center">
        ...
        <div className="ml-8 text-lg">
          <span className="hover:text-radix-violet9 hover:cursor-pointer">
            Enrolled
          </span>
        </div>
        <div className="ml-8 text-lg">
        ...
        <div className="pt-1 ml-8 p-1 rounded hover:bg-gray-500 hover:cursor-pointer relative flex flex-col items-center group">
          <svg
            width="20"
            height="20"
            viewBox="0 0 15 15"
          ...
          <div className="absolute top-0 flex-col items-center hidden mt-9 group-hover:flex">
            <div className="w-2 h-3 -mb-2 rotate-45 bg-white"></div>
            <strong className="relative z-10 p-2 text-xs leading-none text-black whitespace-no-wrap bg-white shadow-lg rounded">
              More
            </strong>
          </div>
        </div>
      ...
      <div className="flex items-center relative">
        <input
          className="p-2 rounded-md  bg-gray-900 w-96 h-10 focus:ring-2 focus:ring-radix-violet9 focus:outline-none"
          type="search"
          name="search"
          placeholder="Search"
        />
        <button
          type="submit"
          className="absolute top-0 right-0 bottom-0 py-2 px-2 ">
          <svg
            width="20"
            height="20"
            viewBox="0 0 15 15"
      ...
      <div className="flex items-center">
        <div className="pt-1 p-1 rounded hover:bg-gray-500 hover:cursor-pointer relative flex flex-col items-center group">
          <svg
            width="20"
            height="20"
            viewBox="0 0 15 15"
        ...
        <div className="relative group mx-8">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-radix-purple9 to-radix-blue9 rounded-lg blur opacity-70 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
          <button className="relative px-2 py-2 bg-black rounded-lg leading-none flex items-center">
            <strong className="text-radix-violet8 group-hover:text-radix-purple8 transition duration-200">
              Connect Wallet
            </strong>
          </button>
        </div>
        <div className="mx-2 px-2 hover:cursor-pointer">
          <svg
            width="15"
            height="15"
            viewBox="0 0 15 15"
